...
Public Class FrmSST4500_1_0_0J_meas
    ...
    Private Sub AdmVisible_onoff(ByVal sw As Boolean)
        ...
        他の測定データ選択ToolStripMenuItem.Enabled = sw
        GroupBox5.Visible = sw
        過去データToolStripMenuItem.Enabled = sw
                    ...
                    If Ret = DialogResult.OK Then
                        ...
                        Else
                            ...
                            With sheet
                                ...
                                .Range(.Cells(3, 1), .Cells(3, 1)).Font.Color = Color.Blue
                                ...
                                .Range(.Cells(7, 1), .Cells(7, 4)).Font.Color = Color.Blue
                                .Range(.Cells(5, 1), .Cells(7, 4)).Borders.LineStyle = Excel.XlLineStyle.xlContinuous
                                .Range(.Cells(5, 1), .Cells(7, 4)).Locked = True

                                .Range(.Cells(9, 1), .Cells(9, 1)).MergeCells = True
                                .Cells(9, 1) = "データ"
                                .Range(.Cells(9, 2), .Cells(9, 2)).MergeCells = True
                                .Cells(9, 2) = "測定No."
                                ...
                                .Range(.Cells(12, 1), .Cells(12, 12)).Font.Color = Color.Blue
                                ...
                                .Range(.Cells(15, 12), .Cells(31, 12)).Font.Color = Color.Blue
    ...
    Private Sub FrmSST4500_1_0_0J_meas_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        e.Cancel = True
        FlgMainMeas = 90
    End Sub
    ...
    Private Sub 他の測定データ選択ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 他の測定データ選択ToolStripMenuItem.Click
        FlgMainMeas = 41
    End Sub
